...
ax.scatter(obs_xray[0,6], obs_xray[0,8],s=sx, marker="^",color=cx,edgecolors="black")
ax.scatter(obs_xray[1,6], obs_xray[1,8],s=sx, marker="^",color=cx,edgecolors="black")
ax.scatter(obs_xray[2,6], obs_xray[2,8],s=sx, marker="^",color=cx,edgecolors="black")




ax.annotate(s="PR (X-ray)",xy = (obs_xray[0,6], obs_xray[0,8]), xytext = (obs_xray[0,6]+3*eps, obs_xray[0,8]+ 1.0*eps),arrowprops=dict(facecolor='lightgrey',headwidth=15.0,headlength=10.0, width=6.0,linewidth=1.0,shrink=0.15),verticalalignment="center",horizontalalignment="center",bbox=square_box)
ax.annotate(s="PTS (X-ray)",xy = (obs_xray[1,6], obs_xray[1,8]), xytext = (obs_xray[1,6]+2*eps, obs_xray[1,8]-3*eps),arrowprops=dict(facecolor='lightgrey',headwidth=15.0,headlength=10.0,width=6.0,linewidth=1.0,shrink=0.15),verticalalignment="center",horizontalalignment="center")
ax.annotate(s="PPS (X-ray)",xy = (obs_xray[2,6], obs_xray[2,8]), xytext = (obs_xray[2,6]+ 5*eps, obs_xray[2,8]),arrowprops=dict(facecolor='lightgrey',headwidth=15.0,headlength=10.0,width=6.0,linewidth=1.0,shrink=0.15),verticalalignment="center",horizontalalignment="center")

ax.text(s="PR (X-ray)",x = obs_xray[0,6]+3*eps, y = obs_xray[0,8]+ 1.0*eps,bbox=square_box,ha='center', va = 'center')
ax.text(s="PTS (X-ray)",x = obs_xray[1,6]+2*eps,y= obs_xray[1,8]- 3*eps, bbox=square_box,ha='center', va = 'center')
ax.text(s="PPS (X-ray)",x = obs_xray[2,6]+ 5*eps,y= obs_xray[2,8], bbox = square_box,ha='center', va = 'center')
...
lw2 = 3.5
cax =ax.contour(X,Y,pdf_pr1, colors=prw_color)
#~ cax.clabel(fontsize=6.0,inline=True)
cax =ax.contour(X,Y,pdf_pr2, colors=prwr_color,linewidths=lw2)
#~ cax.clabel(fontsize=6.0,inline=True)

cax =ax.contour(X,Y,pdf_pts1, colors=ptsw_color)
#~ cax.clabel(fontsize=6.0,inline=True)
cax =ax.contour(X,Y,pdf_pts2, colors=ptswr_color)
#~ cax.clabel(fontsize=6.0,inline=True)


cax =ax.contour(X,Y,pdf_ppa1, colors=ppaw_color)
#~ cax.clabel(fontsize=6.0,inline=True)
cax =ax.contour(X,Y,pdf_ppa2, colors=ppawr_color,linewidths=lw2)
#~ cax.clabel(fontsize=6.0,inline=True)
